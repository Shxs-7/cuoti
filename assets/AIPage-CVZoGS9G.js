import{f as B,u as D,b as G,r as x,j as s}from"./index-CvHGgT47.js";import{j as k,J,C as F}from"./journal.service-CRNE5ux8.js";import{q as T}from"./question.service-BlehkaDN.js";import{r as M}from"./review.service-CUf1VmV4.js";import{k as O}from"./knowledge.service-DhIwe9C7.js";import{B as N}from"./Button-C6kLMuqE.js";import"./tag.service-Bj65VCZl.js";const I=B("ai"),P="cuoti-ai-apikey",K="cuoti-ai-url",U="cuoti-ai-model",Q="https://api.deepseek.com/v1/chat/completions",Y="deepseek-chat",W=25e3;async function _(n,i,a=W){const l=new AbortController,e=setTimeout(()=>l.abort(),a);try{return await fetch(n,{...i,signal:l.signal})}finally{clearTimeout(e)}}async function H(){const[n,i,a]=await Promise.all([k.getAll(),T.getRecent(20),O.getAll()]),l=i.map(o=>`- 【${o.title||"无标题"}】难度${o.difficulty}/5 标签：${Array.isArray(o.tags)?o.tags.join("、"):"无"}，我的错误答案：${o.wrongAnswer||"未记录"}`).join(`
