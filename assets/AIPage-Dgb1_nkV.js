import{f as B,u as D,b as G,r as x,j as s}from"./index-M9JcXG4Z.js";import{j as k,J,C as F}from"./journal.service-BH-LEfcg.js";import{q as T}from"./question.service-yfsmSBcw.js";import{r as M}from"./review.service-RsBl6Exk.js";import{k as O}from"./knowledge.service-BeYUx7jO.js";import{B as N}from"./Button-UsIxAa64.js";import"./tag.service-Bbj1v8kK.js";const I=B("ai"),P="cuoti-ai-apikey",K="cuoti-ai-url",U="cuoti-ai-model",Q="https://api.deepseek.com/v1/chat/completions",Y="deepseek-chat",W=15e3;async function _(n,i,a=W){const l=new AbortController,e=setTimeout(()=>l.abort(),a);try{return await fetch(n,{...i,signal:l.signal})}finally{clearTimeout(e)}}async function H(){const[n,i,a]=await Promise.all([k.getAll(),T.getRecent(20),O.getAll()]),l=i.map(o=>`- 【${o.title||"无标题"}】难度${o.difficulty}/5 标签：${Array.isArray(o.tags)?o.tags.join("、"):"无"}，我的错误答案：${o.wrongAnswer||"未记录"}`).join(`
...
`),g={};for(const r of c){const m=r.category||"未分类";(g[m]=g[m]||[]).push(r.wrongReasons||"")}const t=Object.entries(g).map(([r,m])=>{const b=m.filter(Boolean);return b.length?`${r}（${b.length} 条）：
${b.slice(0,5).map(R=>`- ${R}`).join(`
`)}`:`${r}：暂无错因记录`}).join(`
